...
#define SERIAL_DEBUG Serial // DEBUG port
#define SERIAL_RS485 Serial1
// cell module Data uses Rx2/TX2 and debug logs go to serial0 - USB
//#define SERIAL_DATA Serial2

// I2C settings
// defined in HAL_ESP32.cpp
//#define SDA  21
//#define SCL  22
...
{
  RELAY_ON = 0xFF,
  RELAY_OFF = 0x99, // PCF8574 pinstate is LOW
  RELAY_X = 0x00    // PCF8574 pinstate is LOW
};
